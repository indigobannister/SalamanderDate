...
cohen_weight
```
Mean weight (g) differed significantly between salamanders found in **____** (one-way ANOVA with post-hoc Tukey's HSD, (F(`r aov_outputs[1]`, `r aov_outputs[2]`) = `r round(aov_outputs[7],2)`, *p* = `r round(aov_outputs[9],3)`). 
